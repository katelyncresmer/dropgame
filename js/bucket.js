...
function Bucket(x,y){
	...
	this.width=100; //keep track of buckets width
	this.height=100; //keep track of buckets height
	...
	*/
	this.create = function(){
		...
		this.item_on_page.style.backgroundColor="rgba(151,53,153,.5)";
	...
	/** 
	*   The destroy function does lots of cleaning up when a bucket is removed from the page rhueleuhr
	*/
	this.destroy = function(){
		...
		//remove this bucket from the array. First look up and store the current bucketd index # in the array
		var this_buckets_index_num=bucketArray.indexOf(this);
		//remove exactly on dro from teh array, starting at the current bucket's index number
